...
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.FILE;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.IMAGE;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.MARKDOWN;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.MINIPROGRAM_NOTICE;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.MPNEWS;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.NEWS;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.TEXT;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.TEXTCARD;
import static me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType.VIDEO;
...
import me.chanjar.weixin.cp.constant.WxCpConsts.LinkedCorpMsgType;
...
public class WxCpLinkedCorpMessage implements Serializable {
    ...
    /**
     * 成员ID列表（消息接收者，最多支持1000个）。每个元素的格式为：
     * corpid/userid，其中，corpid为该互联成员所属的企业，userid为该互联成员所属企业中的帐号。如果是本企业的成员，则直接传userid即可
     */
